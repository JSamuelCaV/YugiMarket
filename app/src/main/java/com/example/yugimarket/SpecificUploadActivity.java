...
public class SpecificUploadActivity extends AppCompatActivity {
    ...
    String image_url_small,name,set_code;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (dprice!=0.0 && inumber_to_sell!=0 && sseller!="") {
                    ...
                    UploadCards(view ,name, set_code ,dprice,inumber_to_sell,sseller,image_url_small);
    ...
    private void UploadCards(View view,String name,String set_code,Double fprice,int inumber_to_sell,String sseller,String image_url_small){
